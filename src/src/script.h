...
#ifndef H_GXCOIN_SCRIPT
#define H_GXCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CGxcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Gxcoin always counted CHECKMULTISIGs
