    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new GxcoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->gxcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Gxcoin."), QMessageBox::Ok);
